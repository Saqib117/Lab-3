...
{
	if(b > (OSPFS_NDIRECT + OSPFS_NINDIRECT - 1) && b < OSPFS_MAXFILEBLKS)
	  return 0;
	else
	  return -1;
}
...
{
	// Your code here.
	if(b >= OSPFS_NDIRECT && b <= (OSPFS_NDIRECT + OSPFS_NINDIRECT - 1))
	  return 0;
	else
	  return -1;
}
...
{
	// Your code here.
	if(b >= 0 && b <= (OSPFS_NDIRECT - 1))
	  return b;
	else if(b > (OSPFS_NDIRECT -1) && b <= (OSPFS_NDIRECT + OSPFS_NINDIRECT - 1))
	  return (b-OSPFS_NDIRECT);
	else if(b > (OSPFS_NDIRECT + OSPFS_NINDIRECT - 1) && b < OSPFS_MAXFILEBLKS)
